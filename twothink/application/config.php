...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => ';U7^r<aH%fTLoOJckAGQht.u_/V+enmy?0B{*dwz', //默认数据加密KEY
	'data_cache_key'=> ';U7^r<aH%fTLoOJckAGQht.u_/V+enmy?0B{*dwz',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>';U7^r<aH%fTLoOJckAGQht.u_/V+enmy?0B{*dwz', //加密KEY
