<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/repairs\index.html";i:1506696293;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $repairs['odd']; ?></td>
            <td><?php echo $repairs['name']; ?></td>
            <td><?php echo $repairs['del']; ?></td>
            <td><?php echo $repairs['addr']; ?></td>
            <td><?php echo $repairs['title']; ?></td>
            <td><?php echo $repairs['content']; ?></td>
            <td><?php echo date('Y-m-d H:i:s',$repairs['create_time']); ?></td>
            <td class="status"><?php echo !empty($repairs['status']) && $repairs['status']==1?'已处理':'未处理'; ?></td>
            <td>
                <a title="处理" href="<?php echo url('status?id='.$repairs['id']); ?>" class="btn btn-info"><?php echo !empty($repairs['status']) && $repairs['status']==1?'':'处理'; ?></a>
                <a title="编辑" href="<?php echo url('edit?id='.$repairs['id']); ?>">编辑</a>
