<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/repairs\edit.html";i:1506676843;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container-fluid">
        <form action="<?php echo url(); ?>" method="post"  class="form-horizontal">
            ...
            <div class="form-item">
                <label class="item-label">您的姓名(必填):<span class="check-tips">（用于显示的文字）</span></label>
                <div class="controls">
            ...
            <div class="form-item">
                <label class="item-label">您的电话(必填):<span class="check-tips">（用于显示的文字）</span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="del"  value="<?php echo (isset($info['del']) && ($info['del'] !== '')?$info['del']:''); ?>">
                </div>
            </div>

            <div class="form-item">
                <label class="item-label">您的地址(必填):<span class="check-tips">（用于显示的文字）</span></label>
                <div class="controls">
            ...
            <div class="form-item">
                <label class="item-label">标题(必填):<span class="check-tips">（用于显示的文字）</span></label>
                <div class="controls">
            ...
            <div class="form-item">
                <label class="item-label">内容(详细描述需要报修的内容):<span class="check-tips">（用于显示的文字）</span></label>
                <div class="controls">
                    <textarea  type="text" class="text input-large" name="content" style="height: 200px;">
